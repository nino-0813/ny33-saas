...
export const checkDetails: Record<string, CheckDetailContent> = {
  access: {
    ...
    subMetrics: [
      { label: "ページビュー", value: "18,420", sub: "前月比 +8%" },
      { label: "ユーザー数", value: "9,310", sub: "前月比 +6%" },
      { label: "問い合わせ数", value: "34", sub: "件 / 月" },
      { label: "直帰率", value: "42%", sub: "良好" },
    ],
  ...
  seo: {
    ...
    subMetrics: [
      { label: "平均検索順位", value: "12.4", sub: "位" },
      { label: "表示回数", value: "51,200", sub: "回 / 月" },
      { label: "クリック率", value: "3.8%", sub: "平均以上" },
      { label: "上位表示KW", value: "28", sub: "語" },
    ],
  ...
  gbp: {
    ...
    subMetrics: [
      { label: "クチコミ数", value: "48", sub: "件" },
      { label: "平均評価", value: "4.2", sub: "/ 5.0" },
      { label: "投稿数", value: "3", sub: "件 / 月" },
  ...
  sns: {
    ...
    subMetrics: [
      ...
      { label: "エンゲージメント率", value: "3.1%", sub: "" },
      { label: "投稿数", value: "86", sub: "件" },
      { label: "月間増加", value: "+62", sub: "人" },
    ],
  ...
  speed: {
    ...
    subMetrics: [
      { label: "LCP", value: "2.1s", sub: "良好" },
      { label: "INP", value: "180ms", sub: "良好" },
      { label: "CLS", value: "0.05", sub: "良好" },
      { label: "モバイルスコア", value: "90", sub: "/ 100" },
    ],
  ...
  mobile: {
    ...
    subMetrics: [
      { label: "タップ要素", value: "適切", sub: "" },
      { label: "ビューポート", value: "OK", sub: "" },
      { label: "文字サイズ", value: "読みやすい", sub: "" },
      { label: "モバイル流入", value: "62%", sub: "" },
    ],
  ...
  security: {
    ...
    subMetrics: [
      { label: "SSL", value: "有効", sub: "" },
      { label: "証明書", value: "残90日", sub: "" },
      { label: "既知の脆弱性", value: "0", sub: "件" },
      { label: "安全性評価", value: "A", sub: "" },
    ],
  ...
  content: {
    ...
    subMetrics: [
      ...
      { label: "更新頻度", value: "月1回", sub: "低め" },
      { label: "平均文字数", value: "1,200", sub: "字" },
      { label: "重複コンテンツ", value: "0", sub: "件" },
    ],
  ...
  competitor: {
    ...
    subMetrics: [
      ...
      { label: "自社順位", value: "17位", sub: "/ 120社" },
      { label: "強み", value: "Web集客", sub: "" },
      { label: "弱み", value: "口コミ", sub: "" },
    ],
  ...
  anomaly: {
    ...
    subMetrics: [
      { label: "異常検知", value: "0", sub: "件" },
      { label: "稼働率", value: "100%", sub: "" },
      { label: "エラー", value: "0", sub: "件" },
